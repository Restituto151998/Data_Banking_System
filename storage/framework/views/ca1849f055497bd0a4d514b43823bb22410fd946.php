        ...
        <div class="container mt-5">
            <div class="card" style="width: 28rem;">
                <div class="card-body" style="background:#21791A;">
                    <h5 class="card-title text-white">Reset Password</h5>
                </div>
            </div>
            <div class="card " style="width: 28rem;">
                <div class="card-body ">
                    <form method="POST" action="<?php echo e(route('auth.passwords.reset')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="input-group mb-3" style="position: relative;">
                            <span class="input-group-text" id="inputGroup-sizing-default"> <i class="fa fa-user"
                                    style="font-size:24px"></i></span>
                            <input type="text" id="cur" class="form-control" placeholder="Username"
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <span class="text-danger">
                                <strong>Password required minimum 8 characters!</strong>
                            </span>
                        <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        <div>
                            <button id="change_button" type="submit" class="btn w-50 text-white"
                                style="background:#21791A;">Reset Password</button>
                        </div>
            ...
            <a href="/login" style="">Back to Login</a>
        </div>
        </div>
    </center>
...
<?php /**PATH C:\Users\capstonestudent\Desktop\Data_Banking_System\resources\views/auth/passwords/reset.blade.php ENDPATH**/ ?>